        ...
        <form className="flex flex-col mt-3" onSubmit={handleSubmit(onSubmit)}>
            ...
            {pathname === '/auctions/create' &&
                <>
                    ...
                    <div className='grid grid-cols-2 gap-3'>
                        <Input label='Reserve Price (enter zero if no reserve)' name='reservePrice' control={control} type='number' rules={{ required: 'Reserve Price is required' }} />
                        <DateInput label='Auction end date/time' name='auctionEnd' control={control} dateFormat='dd MMMM yyyy h:mm a' showTimeSelect rules={{ required: 'Auction end is required' }} />
                    </div>
                </>
            }
